        ...
        <section className="bg-light py-5 text-center animated fadeInUp delay-1s">
          ...
          <div className="row mt-4 justify-content-center">
            <div className="col-md-3">
              <p>
                <strong>1️⃣</strong> Enter a word or pick a theme
              </p>
            </div>
            <div className="col-md-3">
              <p>
                <strong>2️⃣</strong> MicroMuse generates a story instantly
              </p>
            </div>
            <div className="col-md-3">
              <p>
                <strong>3️⃣</strong> Save, share, or get daily updates
              </p>
            </div>
          </div>
        </section>
